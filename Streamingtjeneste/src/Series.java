...
public class Series extends RollingPictures{
    ...
    public static String getUserInputSerie() {
        System.out.println("Write the serie you want to search for");
    ...
    public static void playSerie() {
        System.out.println("Enter the name of the serie you want to watch:");
